class Course < ApplicationRecord
  ...
  validates :long_description, presence: false, length: { maximum: 280 },length: { minimum: 100 }
  ...
  validates :what, presence: true,length: { maximum: 280 },length: { minimum: 100 }
  validates :how, presence: true,length: { maximum: 280 },length: { minimum: 100 }
  validates :project, presence: true,length: { maximum: 280 },length: { minimum: 100 }
